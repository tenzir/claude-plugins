...
The `tenzir-changelog` framework manages the changelog/ directory. Read the
...
When adding changelog entries to a package, spawn the `changelog:adder`
subagent. Invoke the `changelog:managing-entries` for in-depth knowledge and
