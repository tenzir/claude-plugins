...
|-----------|------|
| `action_id` | integer_t |
| `actual_permissions` | integer_t |
| `confidence_id` | integer_t |
| `disposition_id` | integer_t |
| `exit_code` | integer_t |
| `injection_type` | string_t |
| `injection_type_id` | integer_t |
| `is_alert` | boolean_t |
| `launch_type` | string_t |
| `launch_type_id` | integer_t |
| `message` | string_t |
| `module` | object (module) |
| `observables` | object (observable) |
| `requested_permissions` | integer_t |
| `status` | string_t |
