...
| `prev_security_level` | string_t |
| `prev_security_level_id` | integer_t |
| `prev_security_states` | object (security_state) |
| `security_level` | string_t |
| `security_level_id` | integer_t |
| `security_states` | object (security_state) |
| `state_id` | integer_t |
| `status` | string_t |
