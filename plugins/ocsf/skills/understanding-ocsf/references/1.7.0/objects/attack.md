...
|-----------|------|-------------|
| `mitigation` | object (mitigation) | optional |
| `sub_technique` | object (sub_technique) | recommended |
| `tactic` | object (tactic) | recommended |
| `tactics` | object (tactic) | optional |
| `technique` | object (technique) | recommended |
